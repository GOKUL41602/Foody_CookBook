...
public class FoodDataServices {
    ...
    public void getRandomFood(VolleyResponseListener volleyResponseListener) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONArray foodDetails = response.getJSONArray("meals");
                    for (int i = 0; i < foodDetails.length(); i++) {
                        JSONObject food = foodDetails.getJSONObject(i);
